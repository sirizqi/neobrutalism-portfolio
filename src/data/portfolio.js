export const portfolioData = {
  personal: {
    ...
    tagline: "a Professional Product Executor, with 10+ years experience in Product Life Cycle.",
  ...
  experiences: [
    {
      company: "KiriminAja (PT. Selalu Siap Solusi)",
      logo: "/logos/tech-giant.png",
  ...
  projects: [
    {
      title: "Koda (PT. Panda Advis Teknologi)",
  ...
  rateCards: [
    {
      ...
      points: [
        "Free for community/student events (limited)",
        "Regional/National/International scales",
        "Topics: Product Management, UI/UX, Career Path",
      ],
      cta: "https://wa.me/6285882266490"
    },
    {
      type: "training",
      title: "Training",
